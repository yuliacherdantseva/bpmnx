...
public class _jet_sequencexsd implements JET2Template {
    ...
    private static final TagInfo _td_c_choose_4_4 = new TagInfo("c:choose", //$NON-NLS-1$
            4, 4,
            new String[] {
            },
            new String[] {
            } );
    private static final TagInfo _td_c_when_5_5 = new TagInfo("c:when", //$NON-NLS-1$
            5, 5,
            new String[] {
                "test", //$NON-NLS-1$
            },
    ...
    private static final TagInfo _td_c_when_8_5 = new TagInfo("c:when", //$NON-NLS-1$
            8, 5,
            new String[] {
                "test", //$NON-NLS-1$
            },
    ...
    public void generate(final JET2Context context, final JET2Writer __out) {
        ...
        while (_jettag_c_if_1_1.okToProcessBody()) {
            ...
            _jettag_c_iterate_3_3.setRuntimeParent(_jettag_c_if_1_1);
            ...
            while (_jettag_c_iterate_3_3.okToProcessBody()) {
                RuntimeTagElement _jettag_c_choose_4_4 = context.getTagFactory().createRuntimeTag(_jetns_c, "choose", "c:choose", _td_c_choose_4_4); //$NON-NLS-1$ //$NON-NLS-2$
                _jettag_c_choose_4_4.setRuntimeParent(_jettag_c_iterate_3_3);
                _jettag_c_choose_4_4.setTagInfo(_td_c_choose_4_4);
                _jettag_c_choose_4_4.doStart(context, out);
                JET2Writer _jettag_c_choose_4_4_saved_out = out;
                while (_jettag_c_choose_4_4.okToProcessBody()) {
                    out = out.newNestedContentWriter();
                    RuntimeTagElement _jettag_c_when_5_5 = context.getTagFactory().createRuntimeTag(_jetns_c, "when", "c:when", _td_c_when_5_5); //$NON-NLS-1$ //$NON-NLS-2$
                    _jettag_c_when_5_5.setRuntimeParent(_jettag_c_choose_4_4);
                    _jettag_c_when_5_5.setTagInfo(_td_c_when_5_5);
                    _jettag_c_when_5_5.doStart(context, out);
                    JET2Writer _jettag_c_when_5_5_saved_out = out;
                    while (_jettag_c_when_5_5.okToProcessBody()) {
                        out = out.newNestedContentWriter();
                        ...
                        _jettag_c_get_6_28.setRuntimeParent(_jettag_c_when_5_5);
                        ...
                        _jettag_c_get_6_82.setRuntimeParent(_jettag_c_when_5_5);
                        _jettag_c_get_6_82.setTagInfo(_td_c_get_6_82);
                        _jettag_c_get_6_82.doStart(context, out);
                        _jettag_c_get_6_82.doEnd();
                        out.write("\"/>");  //$NON-NLS-1$        
                        out.write(NL);         
                        _jettag_c_when_5_5.handleBodyContent(out);
                    }
                    out = _jettag_c_when_5_5_saved_out;
                    _jettag_c_when_5_5.doEnd();
                    RuntimeTagElement _jettag_c_when_8_5 = context.getTagFactory().createRuntimeTag(_jetns_c, "when", "c:when", _td_c_when_8_5); //$NON-NLS-1$ //$NON-NLS-2$
                    _jettag_c_when_8_5.setRuntimeParent(_jettag_c_choose_4_4);
                    _jettag_c_when_8_5.setTagInfo(_td_c_when_8_5);
                    _jettag_c_when_8_5.doStart(context, out);
                    JET2Writer _jettag_c_when_8_5_saved_out = out;
                    while (_jettag_c_when_8_5.okToProcessBody()) {
                        out = out.newNestedContentWriter();
                        out.write("\t\t\t\t    <xsd:element name=\"");  //$NON-NLS-1$        
                        ...
                        _jettag_c_get_9_28.setRuntimeParent(_jettag_c_when_8_5);
                        ...
                        _jettag_c_get_9_87.setRuntimeParent(_jettag_c_when_8_5);
                        _jettag_c_get_9_87.setTagInfo(_td_c_get_9_87);
                        _jettag_c_get_9_87.doStart(context, out);
                        _jettag_c_get_9_87.doEnd();
                        out.write("\"/>");  //$NON-NLS-1$        
                        out.write(NL);         
                        _jettag_c_when_8_5.handleBodyContent(out);
                    }
                    out = _jettag_c_when_8_5_saved_out;
                    _jettag_c_when_8_5.doEnd();
                    _jettag_c_choose_4_4.handleBodyContent(out);
                }
                out = _jettag_c_choose_4_4_saved_out;
                _jettag_c_choose_4_4.doEnd();
